...
namespace GooglePlayGames.Native.PInvoke
{
    ...
    static class Callbacks
    {
        ...
        {
            OurUtils.Logger.d("Received UI callback: " + status);
        };
        ...
        private static T IntPtrToCallback<T>(IntPtr handle, bool unpinHandle) where T : class
        {
            ...
            {
                OurUtils.Logger.e("GC Handle pointed to unexpected type: " + gcHandle.Target.ToString() +
                    ". Expected " + typeof(T));
                throw e;
            }
            finally
        ...
        {
            OurUtils.Logger.d("Showing UI Internal callback: " + status);
            ...
            {
                OurUtils.Logger.e("Error encountered executing InternalShowAllUICallback. " +
        ...
        {
            OurUtils.Logger.d("Entering internal callback for " + callbackName);
                                                        ...
                                                        T param1, IntPtr param2, IntPtr userData)
        {
            ...
            {
                OurUtils.Logger.e("Error encountered converting " + callbackName + ". " +
                    "Smothering to avoid passing exception into Native: " + e);
                return;
            }

            OurUtils.Logger.d("Internal Callback converted to action");
            if (callback == null)
            {
                return;
            }
