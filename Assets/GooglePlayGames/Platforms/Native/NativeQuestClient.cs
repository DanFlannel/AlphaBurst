...
using Types = GooglePlayGames.Native.Cwrapper.Types;
    ...
    internal class NativeQuestClient : IQuestsClient
    {
                                    ...
                                    Action<QuestUiResult, IQuest, IQuestMilestone> callback)
        {
            ...
            {
                OurUtils.Logger.e("Encountered quest that was not generated by this IQuestClient");
        ...
        private static QuestUiResult UiErrorToQuestUiResult(Status.UIStatus status)
        {
            switch (status)
            {
                ...
                default:
                    OurUtils.Logger.e("Unknown error status: " + status);
                    return QuestUiResult.InternalError;
            }
        }
            ...
            Action<QuestUiResult, IQuest, IQuestMilestone> callback)
        {
            return response =>
            {
                ...
                {
                    OurUtils.Logger.e("Quest UI succeeded without a quest acceptance or milestone claim.");
                    acceptedQuest.Dispose();
                    milestone.Dispose();
                               ...
                               Action<QuestClaimMilestoneStatus, IQuest, IQuestMilestone> callback)
        {
            ...
            {
                OurUtils.Logger.e("Encountered milestone that was not generated by this IQuestClient");
